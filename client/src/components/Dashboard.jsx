    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-rose-500 flex items-center justify-between">
                <div>
                    <p className="text-gray-500 text-sm font-medium uppercase">Total Outcome</p>
                    <p className="text-2xl font-bold text-rose-600">-${totalOutcome.toFixed(2)}</p>
                </div>
