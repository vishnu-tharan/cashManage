...
const TransactionList = ({
  ...
  return <div className="bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      {transactions.length === 0 ? <div className="p-8 text-center text-gray-500">
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-100">
              {transactions.map(t => <tr key={t.id} className="hover:bg-gray-50 transition">
                  <td className="p-4">
                ...
                minute: "2-digit"
                  ...
                  <td className="p-4 text-center">
                    <button onClick={() => onDeleteTransaction(t.id)} className="text-gray-400 hover:text-rose-500 transition p-2 rounded-full hover:bg-rose-50">
                      <Trash2 size={18} />
                    </button>
                  </td>
                </tr>)}
